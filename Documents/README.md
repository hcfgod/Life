...
- `EditorAndTooling.md` for the dedicated editor app, `ImGuiSystem`, docking UI, and offscreen scene-surface behavior.
...
- `EditorAndTooling.md` - the dedicated editor app, host-owned `ImGuiSystem`, tooling event/frame integration, and the current scene-surface path.

...
namespace EditorApp
{
    EditorServices EditorServices::Acquire(Life::Application& application)
    {
        ...
        services.AssetDatabase = Life::MakeOptionalRef(application.GetService<Life::Assets::AssetDatabase>());
        ...
        services.SceneRuntime = Life::MakeOptionalRef(application.TryGetService<Life::SceneRuntime>());
